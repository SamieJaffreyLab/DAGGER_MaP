...
#only use this program if you edited the program fold-conrafold-uniq-bit-vectors2.py to utilize the --noncomplementary setting when folding with contrafold
...
#python /home/maxim/maxim_py_programs/fetch_DaVinci_folded_non_complement.py --size_file /home/maxim/smStructure_seq/M2G4_spinach_data/sizer2.tab --fasta_file /home/maxim/DanceMapper/DanceMap_data/Fasta_templates/rG4_constrained/spinach_SC_rG4_constrained.fa --out_file /home/maxim/smStructure_seq/M2G4_spinach_data/sizer2.bpseq --cluster_1_name bit_3957 --cluster_2_name bit_5785 --cluster_3_name bit_5232

#python /home/maxim/maxim_py_programs/fetch_DaVinci_folded_non_complement.py --size_file /home/maxim/smStructure_seq/M2G4_spinach_data/sizer2.tab --fasta_file /home/maxim/DanceMapper/DanceMap_data/Fasta_templates/rG4_constrained/spinach_SC_rG4_constrained.fa --out_file /home/maxim/smStructure_seq/M2G4_spinach_data/sizer2.bpseq --cluster_1_name bit_11952 --cluster_2_name bit_19243 --cluster_3_name bit_32188
...
if __name__ == "__main__":
    ...
    # Fold cluster 1
    result = subprocess.run(["/home/maxim/contrafold/src/contrafold", "predict", "--constraints", constraint_1, '--parens', 'folded/' + args.cluster_1_name + '.fold', '--posteriors', '0.0', 'posteriors_output/' + args.cluster_1_name + '.txt', "--noncomplementary" ], capture_output=True, text=True)
    print("stdout:", result.stdout)
    print("stderr:", result.stderr)

    # Fold cluster 2
    result = subprocess.run(["/home/maxim/contrafold/src/contrafold", "predict", "--constraints", constraint_2, '--parens', 'folded/' + args.cluster_2_name + '.fold', '--posteriors', '0.0', 'posteriors_output/' + args.cluster_2_name + '.txt', "--noncomplementary"], capture_output=True, text=True)
    print("stdout:", result.stdout)
    print("stderr:", result.stderr)

    # Fold cluster 3
    result = subprocess.run(["/home/maxim/contrafold/src/contrafold", "predict", "--constraints", constraint_3, '--parens', 'folded/' + args.cluster_3_name + '.fold', '--posteriors', '0.0', 'posteriors_output/' + args.cluster_3_name + '.txt', "--noncomplementary"], capture_output=True, text=True)
    print("stdout:", result.stdout)
    print("stderr:", result.stderr)
